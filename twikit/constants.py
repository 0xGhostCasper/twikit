...
ARTICLE_FEATURES = {
    # Without the article-content flags X's GraphQL strips the
    # response down to {"article_result_by_rest_id": {"result": {}}}.
    # The flag set below mirrors what x.com's web client sends to the
    # same endpoint as of May 2026 — minimum required for the article
    # body, cover media, and author block to come back populated.
    'profile_label_improvements_pcf_label_in_post_enabled': True,
    'responsive_web_profile_redirect_enabled': False,
    'rweb_tipjar_consumption_enabled': False,
    'verified_phone_label_enabled': False,

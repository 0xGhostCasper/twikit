...
# Feature payload required by the current SearchTimeline endpoint
# (queryId BqWLX1Tjvgh6eSZWEMH_kw). Mirrored from fa0311/TwitterInternalAPIDocument
# — keep in sync when X rotates the queryId.
